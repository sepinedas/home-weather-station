/*
 * FreeSans9pt7b.h - GFX font table, converted from GNU FreeFont and
 * distributed by Adafruit-GFX-Library (BSD license). Used as-is here
 * for text rendering on the e-paper panel; see main/gfx.h/.c for the
 * ESP-IDF port of the Adafruit_GFX code that draws these glyphs.
 */
#pragma once
...
const GFXfont FreeSans9pt7b = {(const uint8_t *)FreeSans9pt7bBitmaps,
                                       (const GFXglyph *)FreeSans9pt7bGlyphs, 0x20,
                                       0x7E, 22};
